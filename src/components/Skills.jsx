...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-20 sm:py-32 md:py-40 px-4 sm:px-6 relative">
      <motion.div
        ref={ref}
        initial={{ opacity: 0 }}
      ...
      >
        ...
        >
          <p className="text-primary text-xs sm:text-sm tracking-[0.4em] uppercase mb-3 sm:mb-4 font-light">My Toolkit</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div className="relative p-6 sm:p-8 rounded-2xl border border-cream/5 bg-dark-card/50 backdrop-blur-sm group-hover:border-primary/20 transition-all duration-500">
                {/* Icon */}
                <span className="text-3xl sm:text-4xl block mb-4 sm:mb-5 group-hover:scale-110 transition-transform duration-300">
                  {skill.icon}
                </span>
                
                {/* Name */}
                <h3 className="text-cream font-semibold text-base sm:text-lg mb-1.5 sm:mb-2 group-hover:text-primary-light transition-colors duration-300">
                  {skill.name}
                </h3>
                
                {/* Description */}
                <p className="text-cream/40 text-xs sm:text-sm font-light leading-relaxed">
                  {skill.description}
                </p>
